...
def from_payload(data: dict, path: str) -> ModelFacts:
    ...
    facts = ModelFacts(
        ...
        loose_edges_total=data.get("loose_edges_total", 0),
        loose_edges_actionable=data.get("loose_edges_actionable", 0),
        linework_containers=data.get("linework_containers", 0),
